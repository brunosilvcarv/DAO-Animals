...
public class TelaPesquisarAnimal extends javax.swing.JFrame {

    private ControleAnimais controleanimal = new ControleAnimais();
    
    public TelaPesquisarAnimal() throws ParseException, DAOException, SQLException {
        initComponents();
        carregarDados();
        carregarMenuPopup();
    }
    ...
    {
        TableModelAnimais modelo =  new TableModelAnimais(controleanimal.listar(cFiltro.getText()));
        tabelaAnimais.setModel(modelo);  
    }
    
    private void selecionarPessoa(MouseEvent evt) throws ParseException, SQLException, DAOException
    {
        ...
        if(linha >= 0)
        {
            ...
            controleanimal.setAnimal(controleanimal.listar(cFiltro.getText()).get(linha));       
        }
    }
    ...
    private void bSairActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSairActionPerformed
        TelaPesquisarAnimal.this.dispose();
