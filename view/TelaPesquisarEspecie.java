...
public class TelaPesquisarEspecie extends javax.swing.JFrame {

    private ControleEspecie controleespecie = new ControleEspecie();
    
    public TelaPesquisarEspecie() throws ParseException, DAOException, SQLException {
        initComponents();
        carregarDados();
        carregarMenuPopup();
    }
    ...
    {
        TableModelEspecies modelo =  new TableModelEspecies(controleespecie.pesquisar(cFiltro.getText()));
        tabelaEspecie.setModel(modelo);  
    }
    
    private void selecionarRaca(MouseEvent evt) throws ParseException, SQLException, DAOException
    {
        int linha = tabelaEspecie.rowAtPoint(evt.getPoint());
        if(linha >= 0)
        {
            tabelaEspecie.setRowSelectionInterval(linha, linha);
            linha = tabelaEspecie.getSelectedRow();
            controleespecie.setEspecie(controleespecie.pesquisar(cFiltro.getText()).get(linha));       
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pesquisar [Espécie]");
        ...
        tabelaEspecie.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                tabelaEspecieMouseReleased(evt);
            }
        });
        jScrollPane1.setViewportView(tabelaEspecie);
    ...
    private void bSairActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSairActionPerformed
        TelaPesquisarEspecie.this.dispose();
    ...
    private void tabelaEspecieMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaEspecieMouseReleased
        try {
            selecionarRaca(evt);
            realizarAcao(evt);
        } catch (ParseException ex) {
    ...
    }//GEN-LAST:event_tabelaEspecieMouseReleased
